Public Class AddVisitation
    ...
    Private Sub AddVisitation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If String.IsNullOrEmpty(TextBox1.Text) Or String.IsNullOrEmpty(TextBox2.Text) Or String.IsNullOrEmpty(TextBox3.Text) Or String.IsNullOrEmpty(DateTimePicker1.Text) Or String.IsNullOrEmpty(RichTextBox1.Text) Then
        ...
        con.Open()
        sql = "INSERT INTO Visitation Values (?,?,?,?,?)"
        Dim cmd As OleDb.OleDbCommand = New OleDb.OleDbCommand(sql, con)
        cmd.Parameters.Add(New OleDb.OleDbParameter("VisitationID", CType(TextBox1.Text, String)))
        ...
        cmd.Parameters.Add(New OleDb.OleDbParameter("VDate", CType(DateTimePicker1.Text, String)))
        cmd.Parameters.Add(New OleDb.OleDbParameter("Reason", CType(RichTextBox1.Text, String)))
        ...
        Try
            ...
            con.Close()
            Me.Close()
            MessageBox.Show("Visitation Added.")
